...
h_conv2 = relu(conv2d(h_conv11, W_conv2) + b_conv2)
...
h_conv3 = relu(conv2d(h_conv21, W_conv3) + b_conv3)
...
h_conv6 = relu(conv2d(h_conv51, W_conv6) + b_conv6)
#
#
...
W_fc1 = weight_variable([4*4 * 512, 512])
