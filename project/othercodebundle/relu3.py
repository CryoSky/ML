...
h_conv13 = relu(conv2d(h_conv12, W_conv13) + b_conv13)
...
h_conv22 = relu(conv2d(h_conv2, W_conv22) + b_conv22)

W_conv23 = weight_variable([3, 3, 128, 128])
b_conv23 = bias_variable([128])
h_conv23 = relu(conv2d(h_conv22, W_conv23) + b_conv23)
h_pool22 = max_pool_2x2(h_conv23)
...
h_conv3 = relu(conv2d(h_pool22, W_conv3) + b_conv3)
...
h_pool2_flat = tf.reshape(h_pool3, [-1, 4*4*512])
