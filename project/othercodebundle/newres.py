...
h_poo321 = frac_pool(h_conv41)[0]#h_pool4 = max_pool_2x2(h_conv41)
...
boundaries = [int(73000/batchsize*3+50000/batchsize*0),int(73000/batchsize*3+50000/batchsize*1)]#,int(73000*2/batchsize*3+500000/batchsize*3),int(73000*2/batchsize*3+500000/batchsize*6)]
...
train_step = tf.train.AdamOptimizer(1.2e-4).minimize(cross_entropy)#1e-4 changed to 1e-3
...
saver.restore(sess, "codebackup/retry89.ckpt")
...
#saver.save(sess, "codebackup/retry89.ckpt")
print('saved')
f = open('trainhistory.txt','wb')#newlabley2
...
#plt.imshow(cccc)
#plt.cm.gist_rainbow# -*- coding: utf-8 -*-
