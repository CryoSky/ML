...
W_conv3 = weight_variable([3, 3, 96, 160])
b_conv3 = bias_variable([160])
h_conv3 = tf.nn.relu(conv2d(h_conv2, W_conv3) + b_conv3)
h_pool3 = max_pool_2x2(h_conv3)


W_conv4 = weight_variable([3, 3, 160, 160])   #89 as 92
b_conv4 = bias_variable([160])
h_conv4 = tf.nn.relu(conv2d(h_pool3, W_conv4) + b_conv4)


W_conv5 = weight_variable([3, 3, 160, 160]) #91 as 94  #95 97 98
b_conv5 = bias_variable([160])
h_conv5 = tf.nn.relu(conv2d(h_conv4, W_conv5) + b_conv5)
h_pool5 = glmax_pool_2x2(h_conv5)


W_fc1 = weight_variable([160, 160])
b_fc1 = bias_variable([160])
h_pool2_flat = tf.reshape(h_pool5, [-1, 160])
...
boundaries = [int(73000*2/batchsize*3+100000/batchsize*4)]
values = [1.5e-4,0.4e-4]
