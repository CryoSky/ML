...
print(h_conv5.shape[1])

ht=5
W_fc1 = weight_variable([ht * ht * 256, hidden])
b_fc1 = bias_variable([hidden])
h_pool2_flat = tf.reshape(h_conv5, [-1, ht * ht*256])
...
for j in range(int(ep)):
  ...
  a=train_accuracy = accuracy.eval(feed_dict={
          x:bbb[startn:startn + 100], y_: labley[startn:startn + 100], keep_prob: 1})
  print(a)
  #valiresult.append(a)
