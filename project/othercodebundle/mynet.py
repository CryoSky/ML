...
h_pool2_flat = tf.reshape(h_conv71, [-1, 64*256])
...
train_step = tf.train.AdamOptimizer(0.1e-4).minimize(cross_entropy,global_step=global_step)#1e-4 changed to 1e-3
...
saver.restore(sess, "codebackup/mymodel7.ckpt")
...
saver.save(sess, "codebackup/mymodel7.ckpt")
print('saved')
