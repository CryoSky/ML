...
W_fc1 = weight_variable([49 * 256, hidden])
b_fc1 = bias_variable([hidden])
h_pool2_flat = tf.reshape(h_conv5, [-1, 49*256])
...
train_step = tf.train.AdamOptimizer(1e-4).minimize(cross_entropy)#1.5e-4 and epoch=7 can get 95 percent
