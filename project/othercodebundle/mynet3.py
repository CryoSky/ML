...
boundaries = [int(73000/batchsize*3+100000/2/batchsize*0),int(73000*2/batchsize*3+100000/2/batchsize*1),int(73000*2/batchsize*3+100000/2/batchsize*3),int(73000*2/batchsize*3+100000/2/batchsize*6)]
values = [1.5e-4,1e-4,0.8e-4,0.8e-4,0.4e-4] #i changed it form 0.4e-4 to 1.5e-4
...
#saver.restore(sess, "codebackup/my3model4.ckpt")
...
saver.save(sess, "codebackup/my3model5.ckpt")
print('saved')
