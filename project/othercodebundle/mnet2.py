...
extra=1;
recover=0;
ep=0 # maybe this is too large
epex=5 #10 i enough but maybe 15 is better
hidden=512
print ("loading bbb")
...
def frac_pool(x):
    return tf.nn.fractional_max_pool(x, [1.0,1.5,1.5,1.0], pseudo_random=True,overlapping=True)
...
W_conv12 = weight_variable([5, 5, 32, 64])
b_conv12 = bias_variable([64])
h_conv12 = tf.nn.relu(conv2d(h_conv11, W_conv12) + b_conv12)
h_conv112=tf.nn.lrn(h_conv12)


W_conv2 = weight_variable([3, 3, 64, 64])
b_conv2 = bias_variable([64])
h_conv2 = tf.nn.relu(conv2d(h_conv112, W_conv2) + b_conv2)
h_conv21=tf.nn.lrn(h_conv2)
h_pool2 = frac_pool(h_conv21)[0]
...
h_conv4 = tf.nn.relu(conv2d(h_conv31, W_conv4) + b_conv4)
h_conv41=tf.nn.lrn(h_conv4)
#h_pool4 = max_pool_2x2(h_conv4)

W_conv5 = weight_variable([3, 3, 128, 128]) #91 as 94  #95 97 98
b_conv5 = bias_variable([128])
h_conv5 = tf.nn.relu(conv2d(h_conv41, W_conv5) + b_conv5)
h_conv51=tf.nn.lrn(h_conv5)
h_pool5 = frac_pool(h_conv51)[0]

W_conv6 = weight_variable([3, 3, 128, 256])   #89 as 92
b_conv6 = bias_variable([256])
h_conv6 = tf.nn.relu(conv2d(h_pool5, W_conv6) + b_conv6)
h_conv61=tf.nn.lrn(h_conv6)
#h_pool6 = frac_pool(h_conv61)[0]

W_conv7 = weight_variable([3, 3, 256, 256]) #91 as 94  #95 97 98
b_conv7 = bias_variable([256])
h_conv7 = tf.nn.relu(conv2d(h_conv61, W_conv7) + b_conv7)
h_conv71=tf.nn.lrn(h_conv7)
h_pool7 = frac_pool(h_conv71)[0]
...
W_fc1 = weight_variable([81 * 256, 2048])
b_fc1 = bias_variable([2048])
h_pool2_flat = tf.reshape(h_pool7, [-1, 81*256])
...
boundaries = [int(73000/batchsize*3+500000/batchsize*0),int(73000/batchsize*3+500000/batchsize*1),int(73000/batchsize*3+500000/batchsize*3),int(73000/batchsize*3+500000/batchsize*6)]
#values = [0.2e-4,0.18e-4,0.17e-4,0.16e-4,0.15e-4] #i changed it form 0.4e-4 to 1.5e-4
values = [1.3e-4,1.2e-4,1e-4,0.8e-4,0.4e-4] 
...
saver.restore(sess, "codebackup/my2model1.ckpt")
...
saver.save(sess, "codebackup/my2model1.ckpt")
print('saved')
