...
train_step = tf.train.AdamOptimizer(0.2e-4).minimize(cross_entropy)#1e-4 changed to 1e-3
...
saver.restore(sess, "codebackup/remodel67.ckpt")
...
saver.save(sess, "codebackup/remodel67.ckpt")
print('saved')
